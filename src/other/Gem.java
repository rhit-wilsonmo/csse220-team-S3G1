 ...
 * 
 * @author Adeline <br>
 *         Purpose: The collectible item class; Loads the image, draws on
 *         screen, and returns bounding box for collisions
 */
public class Gem {
	private int x;
	private int y;
	...
	public Rectangle getBounds() {
		Rectangle r = new Rectangle(x - GEM_WIDTH, y - GEM_HEIGHT, GEM_WIDTH, GEM_HEIGHT);
		return r;
	}// getBounds
